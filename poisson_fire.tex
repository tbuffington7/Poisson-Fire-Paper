...
\begin{figure}[!ht]
  ...
  In light of the linear relationship shown in Figure \ref{fig:pop_relation}, the effects of other socio-demographic factors that influence fire risk can be understood in terms of ``shifts" to the approximately linear cloud of points representing census tracts. This is shown in Figure \ref{fig:sociodemographic}.
