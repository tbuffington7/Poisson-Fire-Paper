...
\begin{figure}[!htb]
  ...
  %
          \subfigure[$b_i=0.1$ mi]{%
              \label{fig:smallband} \includegraphics[width=.5\textwidth,keepaspectratio]{figures/small_band.pdf}
          }%
          \subfigure[$b_i= 1.0$ mi]{%
             \label{fig:largeband} \includegraphics[width=.5\textwidth ,keepaspectratio]{figures/large_band.pdf}
          }\\ % 
            \subfigure[$b_i=b_{i,opt}=0.43$ mi]{%
             \label{fig:optband} \includegraphics[width=.5\textwidth,keepaspectratio]{figures/correct_band.pdf}
...
\begin{figure}[!htb]
  ...
  %
          \subfigure[Histogram of optimized bandwidths]{%
              \label{fig:bhist} \includegraphics[width=.5\textwidth,keepaspectratio]{figures/optimal_band_dist.pdf}
          }%
          \subfigure[Scatterplot of optimized bandwidths vs. average department population density]{%
             \label{fig:popband} \includegraphics[width=.5\textwidth,keepaspectratio]{figures/boptvspopdensity.pdf}
          } % 
           % ------- End of the first row ----------------------%
      \end{center}
...
\end{figure}
  ...
  %
          \subfigure[Fraction of housing units built before 1950]{%
              \label{fig:frac_1950} \includegraphics[width=.5\textwidth,keepaspectratio]{figures/frac_1950.pdf}
          }%
          \subfigure[Fraction of housing units built between 1950 and 1969]{%
             \label{fig:frac1950_1969} \includegraphics[width=.5\textwidth,keepaspectratio]{figures/frac_1950_1969.pdf}
          }\\ % 
            \subfigure[Fraction of housing units built between 1970 and 1989]{%
             \label{fig:frac_1970_1989} \includegraphics[width=.5\textwidth,keepaspectratio]{figures/frac_1970_1989.pdf}
          }
            \subfigure[Fraction of housing units built in 1990 or later]{%
             \label{fig:frac_1990} \includegraphics[width=.5\textwidth,keepaspectratio]{figures/frac_1990.pdf}
          }\\
  ...
  %
          \subfigure[Fraction of housing units occupied by a renter]{%
              \label{fig:frac_rented} \includegraphics[width=.5\textwidth,keepaspectratio]{figures/frac_rented.pdf}
          }%
          \subfigure[Fraction of housing units occupied by the owner]{%
             \label{fig:frac_owner} \includegraphics[width=.5\textwidth,keepaspectratio]{figures/frac_owner.pdf}
          }\\ %           
          \subfigure[Fraction of housing units that are vacant ]{%
             \label{fig:frac_vacant} \includegraphics[width=.5\textwidth,keepaspectratio]{figures/frac_vacant.pdf}
          } % 
            \subfigure[Fraction of housing units that are single (not apartments)]{%
             \label{fig:frac_1_unit} \includegraphics[width=.5\textwidth,keepaspectratio]{figures/frac_1_unit.pdf}
          }
      \end{center}
